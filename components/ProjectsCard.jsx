...
const ProjectsCard = ({ deployedLink, title, description, image, stacks, index }) => {
    ...
    return (
        ...
        <div className='flex flex-col-reverse gap-10 h-auto md:flex md:flex-row justify-between md:h-[45vh]  mt-20  overflow-x-hidden'>
            <div className={`xl:w-2/5 space-y-4 order-2 ${index % 2 !== 0 ? 'md:order-2' : 'md:order-1'}`}>
                <p className="text-4xl text-white font-bold">testtttttttttttttt</p>
                <p className="text-white/70 text-xl leading-[30px] tracking-[1px]">testtttttttttttttt</p>
            ...
            <Image src={usedImage} alt="test" width={100} height={100}/>
            <motion.div
                ref={ref}
                ...
                <div className="w-1/2 h-1/2 relative">
                    <Image layout="fill" className={`  rounded   ${index % 2 !== 0 ? 'md:order-1' : 'md:order-2'}`} src={usedImage} alt="image" />
