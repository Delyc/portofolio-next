...
const ProjectsCard = ({ deployedLink, title, description, image, stacks, index , code}) => {
    ...
    return (
        ...
        <div className='flex flex-col-reverse gap-10 h-auto md:flex md:flex-row justify-between lg:h-[50vh]  mt-20  overflow-x-hidden'>
            <div className={`md:w-1/2 lg:w-2/5 space-y-4 order-2 ${index % 2 !== 0 ? 'md:order-2' : 'md:order-1'}`}>
                ...
                <p className="text-white/70 text-lg leading-[30px] tracking-[1px]">{description}</p>
                <div className="flex gap-5">
                <Link href={deployedLink} className="text-white/70 flex gap-1 items-center" target="_b">
                ...
                <Link href={code} className="text-white/70 flex gap-1 items-center" target="_b">
